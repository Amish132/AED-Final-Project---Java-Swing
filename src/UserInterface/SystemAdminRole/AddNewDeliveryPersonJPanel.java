 ...
 * @author nitin
 */
public class AddNewDeliveryPersonJPanel extends javax.swing.JPanel {

    /**
     * Creates new form AddNewDeliveryPersonJPanel
     */
    private JPanel userProcessContainer;
    private DeliveryLabourOrganization org;
    private Network network;

    AddNewDeliveryPersonJPanel(JPanel userProcessContainer, DeliveryLabourOrganization org, Network network) {
        initComponents();
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        if (!((userName.equals("") || (password.equals("") || (name.equals("") || (add1.equals("") || (state.equals("") || (pin.equals("") || (phone.equals("")))))))))) {
            if (EcoSystem.checkIfUsernameIsUnique(userName)) {
                DeliveryPerson dp = org.getDpd().addDeliveryPerson();
                dp.setName(name);
                dp.setAdd1(add1);
                dp.setAdd2(add2);
                dp.setCity(network.getCityName());
                dp.setPhone(phone);
                dp.setState(state);
                dp.setZip(pin);
                
                
                UserAccount ua = org.getUserAccountDirectory().createUserAccount(userName, password, new DeliveryRole());
            ...
            ManageDeliveryPersonJPanel manageDeliveryPersonJPanel = (ManageDeliveryPersonJPanel) component;
            manageDeliveryPersonJPanel.populate();
                CardLayout layout = (CardLayout) userProcessContainer.getLayout();
                layout.previous(userProcessContainer);
            } else {
